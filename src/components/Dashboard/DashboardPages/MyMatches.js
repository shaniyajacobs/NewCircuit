    ...
    <div className="min-h-screen bg-white p-8">
      ...
      <div className="max-w-[1292px] mx-auto">
        ...
        <div className="mb-6 sm:mb-[50px] xl:mb-[75px] 2xl:mb-[100px] text-left">
          <p className="text-[rgba(33,31,32,0.75)] font-bricolage text-[14px] sm:text-[16px] md:text-[20px] lg:text-[24px] font-medium leading-[130%]">Here are 3 AI-powered suggestions based on your personality indicator results.</p>
        </div>
      </div>
