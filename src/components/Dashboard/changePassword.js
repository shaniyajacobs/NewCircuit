  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="p-10 flex flex-col items-center w-full">
        <div className="p-10 rounded-lg shadow-md w-3/4 min-h-[500px]">
          ...
          <div className="mt-6 flex justify-start">
              <button className="bg-blue-600 text-white py-2 px-6 rounded-md text-lg font-semibold hover:bg-blue-700">
                Back
              </button>
            </div>
          </div>
