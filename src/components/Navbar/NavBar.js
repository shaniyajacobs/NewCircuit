            ...
            <div className="container mx-auto py-4">
                <div className="flex justify-between h-20 items-center">
                    ...
                    <div className="flex space-x-12 pr-4">
                        <Link to="/partnerships" className="text-gray-900 hover:text-[#0E49E8] px-3 py-2 text-base font-medium flex items-center">
                            Partnerships
                            <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                            </svg>
                        </Link>
                        <Link to="/about" className="text-gray-900 hover:text-[#0E49E8] px-3 py-2 text-base font-medium flex items-center">
                            About
                            <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                            </svg>
