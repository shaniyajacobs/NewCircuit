    ...
    >
      <div className="flex flex-col items-center max-w-full w-[948px]">
        ...
        <div
          ...
          className="w-[400px] px-6 py-4 mt-6 text-2xl font-semibold text-blue-700 bg-lime-300 rounded-[20px] shadow-[0px_5px_4px_rgba(0,0,0,0.25)] max-md:px-5 max-md:max-w-full cursor-pointer hover:opacity-90"
