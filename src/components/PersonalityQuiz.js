  ...
  return (
    ...
    >
      <div className="flex flex-col max-w-full w-[948px]">
        <div
          className="font-bold max-md:max-w-full"
        ...
        <div
          className="self-center px-5 py-5 mt-6 ml-3.5 max-w-full font-semibold bg-lime-300 rounded-[30px] shadow-[0px_5px_4px_rgba(0,0,0,0.25)] w-[587px] max-md:pr-5 max-md:max-w-full"
