...
const sections = [
    ...
    content: (
      <ol className="list-decimal space-y-2 pl-5">
        <li>
          ...
          dating events, may require payment of fees charges. All fees are payable in advance and are
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p>
          By opting into SMS from a web form or other medium, you agree to receive SMS messages from Circuit, including
          marketing, delivery/scheduling, account notifications, and customer care. Message frequency varies. Message and
          data rates may apply. Reply <strong>STOP</strong> to opt out.
        </p>
        <p className="text-sm text-gray-600">See our Privacy Policy for more details.</p>
      </div>
    ),
  },
  ...
  // ————— PRIVACY POLICY —————
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>Operate and improve the Platform and user experience.</li>
          <li>Facilitate events (including virtual speed dating) and manage payments.</li> {/* removed “subscriptions” */}
          <li>Provide support; send administrative, promotional, and SMS communications.</li>
          <li>Enforce Terms and community guidelines; detect/prevent fraud and abuse.</li>
          <li>Comply with legal obligations and protect rights, users, and the Platform.</li>
        </ul>
        ...
        <h3 className="font-semibold">4. SMS Communications</h3>
        <p>
          By opting into SMS via web form or other medium, you agree to receive messages for marketing, delivery/scheduling,
          account notifications, and customer care. Message frequency varies. Message and data rates may apply. Reply
            ...
            <nav className="space-y-1">
              {sections.map((s) => (
                <a
                  key={s.id}
                  href={`#${s.id}`}  
                  className="block rounded-lg px-3 py-2 text-sm text-gray-800 hover:bg-white/70"
                >
                  {s.title}
                </a>
              ))}
