...
import DragAndDropRanking from "../pages/dragAndDrop.js"

const TOTAL_STEPS = 16; // Set total quiz steps
...
const QUESTIONS = [
  ...
  "How open are you with your emotions?", "What kind of connection are you hoping to find?", "What is your religion?", "What’s your love language?",
...
"I focus on what I can control most of the time"], ["Logical", "Emotional", "Practical", "I just appreciate someone who's open to learning and growing"], 
   ["I'm an open book", "Depends on how much I trust the person", "I tend to keep my emotions to myself", "It's rare for me to share my emotions"], ["Life partner", "Long-term relationship", "Short-term relationship", "Long-term, open to short", "Short-term, open to long"], ["Agnostic", "Atheist", "Buddhist", "Catholic", "Christian", "Hindu", "Jewish", "Muslim", "Sikh", "Spiritual", "Other", "Prefer not to say"], ["Words of affirmation", "Acts of service", "Quality time", "Physical touch", "Receiving gifts"],
    ...
    <div className="min-h-screen">
      ...
      <div className="relative min-h-screen bg-white flex flex-col items-center justify-center text-center">
        ...
        <div className="mt-[60px] flex flex-col items-center text-center w-full">
          ...
          {/* Updated Responses */}
          {/* Responses OR Drag-and-Drop */}
<div className="flex flex-col gap-4 items-center w-full">
{currentStep === TOTAL_STEPS ? (
  <DragAndDropRanking
    items={["Loyalty", "Communication", "Ambition", "Empathy", "Humor"]}
    onSubmit={(rankedTraits) => handleAnswerClick(rankedTraits)}
  />
) : currentStep === 10 ? (
  <div className="w-[400px]">
    <select
      ...
      defaultValue=""
      className="w-full h-[70px] bg-[#F3F3F3] text-black font-poppins font-semibold text-[24px] rounded-[12px] shadow-md hover:bg-gray-300 transition px-4"
    >
      <option value="" disabled>Select your religion</option>
      {RESPONSES[9].map((option, index) => (
